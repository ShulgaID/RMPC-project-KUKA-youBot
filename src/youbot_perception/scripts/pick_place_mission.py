...
ARM_PREGRASP = [2.95, 2.45, -2.35, -1.85, 2.95]   # вперёд, ~0.075 м над полом, схват открыт
ARM_GRASP = [2.95, -2.45, -2.45, -1.95, 2.95]      # кончик на кубике (пол)
...
class PickPlaceMission:
    ...
    def run(self):
        ...
        self.position_for_grasp(frozen_cube, extra_standoff=0.18)
        ...
        self.position_for_grasp((pad[0], pad[1]), extra_standoff=0.18)
        self.stop_base()
        self.sleep(0.5)
